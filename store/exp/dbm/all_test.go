...
(15:54) jnml@fsc-r550:~/src/store/exp/dbm$ . bench
...
PASS
ok  	store/exp/dbm	111.376s
(16:08) jnml@fsc-r550:~/src/store/exp/dbm$

2013-05-09
==========

# 16:05
jnml@fsc-r630:~/src/store/exp/dbm$ go test -tbench -run TestBench -v -wal -xact
...
PASS
ok  	store/exp/dbm	106.234s
jnml@fsc-r630:~/src/store/exp/dbm$
